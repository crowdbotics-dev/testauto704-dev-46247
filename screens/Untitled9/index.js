...
const Untitled9 = () => {
  return <View style={_styles.bRuIzwqL}>
      <Text style={_styles.fwNaBuyd}>Lorem ipsum…</Text><ImageBackground style={_styles.QurOygWt} source={{
    ...
    }} resizeMode="cover"></ImageBackground><View style={_styles.DJBQosHo}></View></View>;
};
