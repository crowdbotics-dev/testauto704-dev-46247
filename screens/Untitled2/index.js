...
const Untitled2 = () => {
  return <View style={_styles.SLhVZdXz}>
      <View style={_styles.JjQAWIJA}></View><Text style={_styles.PiAPIYLh}>Lorem ipsum…</Text><ImageBackground style={_styles.WnkylgKN} source={{
    ...
    }} resizeMode="cover"><View style={_styles.rTykxPLn}></View></ImageBackground></View>;
};
