...
const Untitled8 = () => {
  return <View style={_styles.GRdycaqH}>
      <View style={_styles.mxatrJId}></View><View style={_styles.EfMBNlML}></View><Text style={_styles.MwdpjMNt}>Lorem ipsum…</Text><ImageBackground style={_styles.FccCcEpn} source={{
